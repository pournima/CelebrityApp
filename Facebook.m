...
//    [appStatus saveShareStatus:@"isActiveFB" withArg2:@"YES"];
    [[NSUserDefaults standardUserDefaults] setObject:@"true" forKey:@"fb_on"];
    [[NSUserDefaults standardUserDefaults] setObject:@"YES" forKey:@"isActiveFB"];
    [[NSUserDefaults standardUserDefaults] setObject:self.accessToken forKey:@"access_token_FB"];
